...
class PostService
{
    ...
    public function adminPostList($filter, $isPage = false)
    {
        ...
        $field = 'a.*,u.user_login,u.xingming,u.user_email';
        ...
        if (!empty($category)) {
            ...
            $field = 'a.*,b.id AS post_category_id,b.list_order,b.category_id,u.user_login,u.xingming,u.user_email';
        }
    ...
    public function publishedArticle($postId, $categoryId = 0)
    {
        ...
        if (empty($categoryId)) {
            ...
            $where = [
                'post.post_type'      => 1,
                'post.create_time' => [['< time', time()], ['> time', 0]],
                'post.post_status'    => 1,
                'post.delete_time'    => 0,
                'post.id'             => $postId
            ];
