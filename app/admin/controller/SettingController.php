...
class SettingController extends AdminBaseController
{
    ...
    public function site()
    {
        ...
        $cmfSettings    = cmf_get_option('tx_settings');
        ...
        $this->assign("tx_settings", $cmfSettings);
    ...
    public function sitePost()
    {
        if ($this->request->isPost()) {
            ...
            $cmfSettings = $this->request->param('tx_settings/a');

            cmf_set_option('tx_settings', $cmfSettings);
    ...
    public function koudian()
    {
        $fuwufei_kd     = Db('option')->where('option_name','fuwufei_kd')->find();
        $this->assign('fuwufei_kd', $fuwufei_kd);
        $liwu_kd     = Db('option')->where('option_name','liwu_kd')->find();
        $this->assign('liwu_kd', $liwu_kd);
        $tuijian     = Db('option')->where('option_name','tuijian')->find();
        $this->assign('tuijian', $tuijian);
        $gaiming     = Db('option')->where('option_name','gaiming')->find();
    ...
    public function koudian_updatePost()
    {
        $data      = $this->request->param();
        Db('option')->where('option_name','fuwufei_kd')->update(['option_value'=>$data['fuwufei_kd']]);
        Db('option')->where('option_name','liwu_kd')->update(['option_value'=>$data['liwu_kd']]);
        Db('option')->where('option_name','tuijian')->update(['option_value'=>$data['tuijian']]);
        Db('option')->where('option_name','gaiming')->update(['option_value'=>$data['gaiming']]);
        $this->success("修改成功！");
    }
