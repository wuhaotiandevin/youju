...
class Client
{
    ...
    public function put($url, $params = array(), array $multipart = array(), array $extra_headers = array())
    {
        return $this->request($url, $params, 'PUT', $multipart, $extra_headers);
    }
    ...
    protected function request($url, $params = array(), $method = 'GET', array $multipart = array(), array $extra_headers = array(),$is_json = false)
    {
        ...
        //if (!empty($this->options['userpwd'])) {
            curl_setopt($curl, CURLOPT_USERPWD, '3f7cae74845548a0b275ab3a5964cbad:cee3fa4ba1c34b38a843637066b16f15');
        //}
