...
class Project extends Agora
{
    ...
    {
        return $this->request('GET', '/channel/'.static::$appid.'/');
    }

    public function channelusers($cname)
    {
        $appid = static::$appid;
        return $this->request('GET', '/channel/user/'.$appid.'/'.$cname);
    }
   
    public function channeluser($uid,$cname)
    {
       $appid = static::$appid;
