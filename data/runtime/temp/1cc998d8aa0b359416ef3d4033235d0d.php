<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"themes/admin_simpleboot3/admin\category\add.html";i:1590734940;s:76:"D:\phpstudy_pro\WWW\youju\public\themes\admin_simpleboot3\public\header.html";i:1590571928;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="form-group">
			 ...
			 <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					...
					<label class="radio-inline"><input type="radio" name="is_hot" value="0"  checked> 否</label>
				</div>
			</div>
			<div class="form-group">
