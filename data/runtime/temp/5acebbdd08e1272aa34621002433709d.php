<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"themes/simpleboot3/portal\search.html";i:1574678274;s:64:"D:\phpstudy_pro\WWW\pw\public\themes\simpleboot3\public\nav.html";i:1574678276;s:67:"D:\phpstudy_pro\WWW\pw\public\themes\simpleboot3\public\footer.html";i:1574678276;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<main id="search" style="min-height: 67px;">
    <div class="limit-wrap">
        ...
        <div class="filter" style="margin-bottom: 20px;">
            <div class="items" style="height: 60px;line-height: 60px;padding-top: 0px;">
                <?php if($tuijian == '1'): ?>
                    所有推荐
                    <?php else: ?>
                    搜索<span style="color:#ffb0a5;"><?php echo $keyword; ?></span>结果如下
                <?php endif; ?>
            </div>   
        </div>
        ...
        <div class="results clearfix">
            <div class="left fl">
                <div class="list clearfix">
                    ...
                    <div class="single"><a href="<?php echo cmf_url('portal/detail/index',array('id'=>$vo['id'])); ?>" target="_blank" class="img">
                        ...
                        </div> <div class="bottom clearfix"><div class="location fl" style="width: 70px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden;"><i class="icon icon-location"></i><?php echo $vo['province']; ?></div> </div></div></div>
