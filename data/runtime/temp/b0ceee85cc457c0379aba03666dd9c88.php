<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"themes/admin_simpleboot3/admin\slide_item\edit.html";i:1590636574;s:76:"D:\phpstudy_pro\WWW\youju\public\themes\admin_simpleboot3\public\header.html";i:1590571928;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li><a href="<?php echo url('SlideItem/add',['slide_id'=>$slide_id]); ?>">添加轮播图页面</a></li>
        <li class="active"><a>编辑轮播图页面</a></li>
    </ul>
                ...
                <table class="table table-bordered">
                   ...
                   <tr>
					 ...
					 <tr>
                        <th>跳转链接</th>
                        <td>
                            <input class="form-control" type="text" name="post[href]" id="keywords" value="<?php echo $result['href']; ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" name="post[content]" id="description"
                                      ...
                                      placeholder="请填写轮播图内容"><?php echo $result['content']; ?></textarea>
                        </td>
                    </tr>-->
                </table>
            </div>
                                ...
                                <a href="javascript:uploadOneImage('图片上传','#thumb');">
                                    <?php if(empty($result['image'])): ?>
                                        ...
                                        <img src="<?php echo cmf_get_image_preview_url($result['image']); ?>" id="thumb-preview"
											 ...
											 <input type="hidden" value="<?php echo cmf_get_image_preview_url($result['image']); ?>" name="post[imgurl]">
                                    <?php endif; ?>
                                </a>
