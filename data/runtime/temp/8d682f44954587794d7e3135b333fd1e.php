<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"themes/admin_simpleboot3/admin\setting\site.html";i:1574678274;s:73:"D:\phpstudy_pro\WWW\pw\public\themes\admin_simpleboot3\public\header.html";i:1574678274;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
				...
				<div class="tabbable">
					<div class="tab-content">
						<div class="tab-pane active" id="A">
							...
							<div class="form-group">
								<label for="input-site_admin_email" class="col-sm-2 control-label">客服一 QQ</label>
								<div class="col-md-6 col-sm-10">
							...
							<div class="form-group">
								<label for="input-site_admin_email" class="col-sm-2 control-label">客服二 QQ</label>
								<div class="col-md-6 col-sm-10">
									<input type="text" class="form-control" id="input-site_admin_email1" name="options[site_admin_email1]" value="<?php echo (isset($site_admin_email1) && ($site_admin_email1 !== '')?$site_admin_email1:''); ?>">
								</div>
							</div>
							<div class="form-group">
