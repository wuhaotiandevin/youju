<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"themes/simpleboot3/user\\login.html";i:1574678276;s:68:"D:\wwwroot\enboo.cn\public\themes\simpleboot3\public\nav.html";i:1574678276;s:71:"D:\wwwroot\enboo.cn\public\themes\simpleboot3\public\footer.html";i:1574678276;}*/ ?>
<!DOCTYPE html>
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>游戏陪玩网-登录</title>
...
<div class="container" style="max-width: 850px;">
    <div class="node_1505866184">
        <div class="row">
            <div class="col-md-7 ">
               <img style="margin-left: 20px;" src="/themes/simpleboot3/public/assets/images/5a5339e764e8a.png">
            </div>
            <div class="col-md-5">
                <form class="js-ajax-form" action="<?php echo url('user/login/doLogin'); ?>" method="post">
                <div class="node_title">
                    <span>用户登录</span>
                    <em>还没有账号？<a href="<?php echo url('/user/register'); ?>">立即注册</a></em>
                </div>
                                                    <div class="form-group field-loginform-mobile required">
<div class="input-group"><div class="input-group-addon"><i class="iconfont icon-shouji"></i></div><input type="text"  class="form-control" id="username" name="username" placeholder="用户名/手机号"></div>
</div>                                <div class="form-group field-loginform-password required">
<div class="input-group"><div class="input-group-addon"><i class="iconfont icon-mima"></i></div><input type="password" class="form-control" id="password" name="password" placeholder="密码"></div>
</div>
...
<label><input type="checkbox" value="1" checked> 下次自动登录</label>

<div class="help-block"></div>
</div>                    </div>
                    <div class="col-md-4">
                        <a href="/user/login/findpassword">忘记密码？</a>
                    </div>
                </div>


                <div class="form-group node_submit">
                    <button type="submit" class="js-ajax-submit btn btn-default">登录</button>                </div>
                </form>  <div> 
