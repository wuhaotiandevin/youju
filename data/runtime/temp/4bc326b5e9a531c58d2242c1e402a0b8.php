<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:50:"themes/admin_simpleboot3/admin\plugin\setting.html";i:1590571928;s:91:"D:\phpstudy_pro\WWW\youju\youju\public\themes\admin_simpleboot3\admin\plugin\functions.html";i:1590571928;s:82:"D:\phpstudy_pro\WWW\youju\youju\public\themes\admin_simpleboot3\public\header.html";i:1590571928;}*/ ?>
<?php 
...
<div class="wrap">
    <ul class="nav nav-tabs">
        <li  <?php if($id == '20'): ?>class="active"<?php endif; ?>><a href="<?php echo url('plugin/setting',array('id'=>20)); ?>">QQ登录设置</a></li>
        <li <?php if($id == '23'): ?>class="active"<?php endif; ?>><a href="<?php echo url('plugin/setting',array('id'=>23)); ?>">微信登录设置</a></li>
        <li <?php if($id == '24'): ?>class="active"<?php endif; ?>><a href="<?php echo url('plugin/setting',array('id'=>24)); ?>">微信支付设置</a></li>
        <li <?php if($id == '25'): ?>class="active"<?php endif; ?>><a href="<?php echo url('plugin/setting',array('id'=>25)); ?>">支付宝支付设置</a></li>
    </ul>
